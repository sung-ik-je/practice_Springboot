...
# 원티드 페이지 열기
url = "https://www.wanted.co.kr/wdlist/518?country=kr&job_sort=job.popularity_order&years=0&years=3&locations=seoul.all"
driver.get(url)
...
# info_data를 텍스트 파일로 저장
with open("info_data.txt", "w", encoding="utf-8") as txt_file:
